...
var selectEntireColumn = toolkit.createAction("SELECT_ENTIRE_COLUMN", function (column, extend) { return ({
...
var CornerIndicator = function (_a) {
    ...
    return (React__namespace.createElement("th", { className: classNames__default['default']("Spreadsheet__header", {
...
var ColumnIndicator = function (_a) {
    ...
    return (React__namespace.createElement("th", { className: classNames__default['default']("Spreadsheet__header", {
            "Spreadsheet__header--selected": selected,
        }), onClick: handleClick, tabIndex: 0 }, label !== undefined ? label : hotFormulaParser.columnIndexToLabel(String(column))));
};
